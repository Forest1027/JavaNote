...
# 2017/8/16
## 2、取派业务分析及导入
受理：客户下单【订单】之后，系统自动为客户分配对应快递员，在系统中生成区间任务【工单】，以短信形式通知快递员，快递员基于百度地图定温客户居住位置，生成路线去客户指定地点取件
...
# 8/17/2017 9:15:24 AM 
## 1、 基于JS访问LBS云服务
不是所有LBS云服务都可以使用js ajax访问，因为有跨域。
...
2. 订单功能录入
	1. 订单数据回显
		1. $(#id).get(0):将$("#id")jQuery对象转换成DOM对象
	2. 运单快速录入数据回显
3. 运单录入保存功能
